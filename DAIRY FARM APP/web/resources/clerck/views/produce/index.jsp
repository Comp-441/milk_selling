...
<html lang="en">
  <head>
   ...
   <%@include file="../../../includes/commonFiles/top.html" %>
      ...
      <div  id="page-content-wrapper">
        <div class="container-fluid">
          ...
          <div class="row" id="production" style="margin: 0px; padding: 6px">
              <div class="col-lg-12">
                  <button id="toggleShown" class="btn btn-success" style="float: right;" onclick="changeToInputandBack('Add new Produce')">
                      Add new Produce
                  </button>
              </div>
                ...
                <div class="col-lg-12">
                  ...
                  <div class="row" id="hide">
                      <div class="col-lg-6" >
                          <%@include file="inputForms/AddProduce.jsp" %>
                      </div>  
                  </div>
              </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                          ...
                          <%@include file="../../../includes/commonFiles/bottom.html" %>
  </body>
</html>
