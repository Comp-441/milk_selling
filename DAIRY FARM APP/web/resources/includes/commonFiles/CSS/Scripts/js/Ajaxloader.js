...
function loadPigAddForm() {
  $("#production").load("loadfiles/addpig.php",function() {

     //Generate  ID
    generateID("../../../pigs/addpigOrRemovePig.php","pig_id");
    generateID("../../../Persons/AddEmployee.php","E_id");

    $("#pig_id").focus();

    //ADD all the nations
      $("#E_Nationality").load("loadfiles/nationslist.php")
...
function generateID(url, input_area) {
  $.ajax({
      type: "POST",
      url: url,
      data: {get_id  : " "},
     ...
     if (checkInputs(pig_id, breed, weight, day, gender)) {
      ...
      xmlhttp.onreadystatechange = function() {
          ...
          if (this.readyState == 4 && this.status == 200) {
             ...
             // Swal.fire("","You added a new pig successfully","success");
            loadPigAddForm();
